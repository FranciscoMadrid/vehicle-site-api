...
export const getById = async(req, res) => {
  try {
    const record = await Log.getById(req.params.id);
...
export const getByVehicleId = async (req, res) => {
  try {
    ...
    const records = await Log.getByVehicleId(vehicleId);
...
export const update = async(req, res) => {
  ...
  try {
    const affectedRows = await Log.update(id, updateData);
...
export const deleteById = async(req, res) => {
  ...
  try {
    const affectedRows = await Log.deleteById(userId);
